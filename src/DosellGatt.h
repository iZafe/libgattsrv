...
struct DosellGatt
{
	...
	// name.
	const std::string &getAdvertisingName() const { return mAdvertisingName; }
	...
	// BOTH advertisingName and advertisingShortName to as empty string ("") to prevent setting the advertising
	// name.
	const std::string &getAdvertisingShortName() const { return mAdvertisingShortName; }
	...
	//
	DosellGatt(const std::string &serviceName, const std::string &advertisingName, const std::string &advertisingShortName, 
...
private:
	...
	bool mEnableSecureConnection;

	// Connectable requested state
	bool mEnableConnectable;

	// Discoverable requested state
	bool mEnableDiscoverable;

	// LE advertising requested state
	bool mEnableAdvertising;

	// Bondable requested state
	bool mEnableBondable;
	...
	// BOTH advertisingName and advertisingShortName to as empty string ("") to prevent setting the advertising
	// name.
	std::string mAdvertisingShortName;
...
extern std::shared_ptr<DosellGatt> THESERVER;
